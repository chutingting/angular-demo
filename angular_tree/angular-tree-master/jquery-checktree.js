...
(function($){
    $.fn.extend({
        ...
        checktree: function(options){
        	var defaultOptions={selectModel:'multi'};
        	var tree=$(this);
            ...
            $(this)
                ...
                .on('change', 'input[type="checkbox"]', function(e){
                    e.stopPropagation();
                    e.preventDefault();
                    if(options.selectModel=='singel'){
                    	tree.find('input[type="checkbox"]').not($(this)).prop('checked', false);
                    }
                    checkParents($(this));
                    checkChildren($(this));
                })
            ...
            var checkChildren = function (c)
            {
                ...
                if (childLi.length){
                	var hasChecked=c.is(':checked');
                	if(!hasChecked)
                		childLi.prop('checked', hasChecked);
                }
            }
        }
